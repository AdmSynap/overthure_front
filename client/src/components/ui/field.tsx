...
// --- FieldSeparator (CORREÇÃO DO ERRO DA IMAGEM) ---
function FieldSeparator({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* O erro de tipagem é resolvido passando as props corretamente ou forçando o tipo se necessário */}
      <Separator 
        className="absolute inset-0 top-1/2" 
        {...({} as React.ComponentPropsWithoutRef<typeof Separator>)} 
      />
      {children && (
        <span
